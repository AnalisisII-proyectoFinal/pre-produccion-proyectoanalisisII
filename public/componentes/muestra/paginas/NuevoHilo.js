...
export function NuevoHilo(date){
    const $nuevohilo = document.createElement('div');
        ...
        <section class="contenedor-muestras">
            <h3 id="n-i-m-hilo"></h3>
            <progress id="n-p-hilo-i" max="100" value="" class="progreso-muestra"></progress>
            <hr> 
            <form action="" class="form-nuevo-hilo">
                ...
                <p><button class="tercer-btn" id="n-h">Nuevo</button></p>
            </form>
        </div>
        <div>
        ...
        function initNuevoHilo(){
          ...
          document.getElementById('n-h').addEventListener('click',(e)=>{
            e.preventDefault();
            const limpiarForm = new UiNuevoHilo();
            limpiarForm.limipiarFormulario();
          });
