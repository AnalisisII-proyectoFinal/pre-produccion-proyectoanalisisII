...
export function Mantenimiento(){
    const $mantenimiento = document.createElement('div');
        ...
        <section class="contenedor-tanques">
            ...
            <hr>
            <form id="f-n-mant" class="form-mantenimiento">
            ...
            <br>
              <div class="botones-institucion">
                <p><button id="btn-m-n" class="tercer-btn">Nuevo</button></p>
                <p><button id="btn-m-g" class="primer-btn">Guardar</button></p>
              </div>
            </div>
        ...
        function initMantenimiento(){
          ...
          document.getElementById('lista-mantenimientos').addEventListener('click',(e)=>{
            if (e.target.classList.contains('editar')) {
              ...
              rConf ? uiMant.eliminarMantenimiento(idmt):servNoti.notificarToast("info","Cancelado");
            }
          })
          ...
          const btnNuevoM=document.getElementById('btn-m-n');
          btnNuevoM.addEventListener('click',()=>{
            uiMant.limpiarFormulario();
          })
