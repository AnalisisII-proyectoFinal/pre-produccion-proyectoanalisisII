...
export function InformeCS(muestras,datos) {
    ...
    $datosInf.innerHTML=`
        <div>
            ...
            <li>1/cargo: <span>${datos[0].c1}</span></li>
        </div>
        <div>
        ...
        <div>
            ...
            <li>Responsable de la informacion: <span>${datos[0].res}</span></li>
            <li>fecha: <span>${fechaActual()}</span></li>
        </div>`;
    ...
    $piePagina.classList.add('inf-datos-cabecera');
    $piePagina.innerHTML=`
        <div>
            <li>1/cargo</li>
            <li>Responsable de la informacion:</li>
            <li>Técnico en salud rural F.</li>
        </div>
        <div>
            <li>${datos[0].ds}</li>
            <li>Vo.Bo.</li>
            <li>Médico Director del distrito de Salud</li>
        </div>
        <div>
            <li>F.__________________________</li>
            <li>Recibido de Municipalidad</li>
            <li>Nombre,Firma y sello quien recibe</li>
        </div>`;
    ...
    $informecs.appendChild($piePagina);
