        ...
        function initEditarIngresoMuestra(){
          ...
          document.getElementById('lista-muestras').addEventListener('click',(e)=>{
            if (e.target.classList.contains('editar')) {
              let idm=e.target.getAttribute('_id')
              const obtnerMuestra = new UiIngMuestra();
              obtnerMuestra.obtenerMuestra(idm)
            }
          })
          ...
          const limpiarForm = document.getElementById('m-btn-n');
          limpiarForm.addEventListener('click',(e)=>{
            const limp = new UiIngMuestra();
            limp.limpiarFormulario();
          })
        }
