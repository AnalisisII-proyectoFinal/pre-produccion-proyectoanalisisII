...
export function Nuevo(){
    const $nuevo = document.createElement('div');
        ...
        <section class="contenedor-tanques">
          <h2>Nuevo Tanque</h2>
            ...
            <div class="botones-institucion">
              <p><button id="btn-t-nt" class="primer-btn">Nuevo</button></p>
              <p><button id="btn-t-n" class="tercer-btn">Guardar</button></p>
            </div>
            <br>
        ...
        function initNuevo(){
          ...
          const btnGuardarTanque=document.getElementById('btn-t-n');
          btnGuardarTanque.addEventListener('click',(e)=>{
            e.preventDefault();
          ...
          const btnNuevoTanque =document.getElementById('btn-t-nt');
          btnNuevoTanque.addEventListener('click',()=>{
            uiTanq.limpiarFormulario();
          })
        }
