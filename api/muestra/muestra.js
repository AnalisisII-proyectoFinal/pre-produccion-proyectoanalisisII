...
//tipomuestra
router.get('/tipomuestra',ctrl.tipomuestra.obtenerTipoMuestras);
router.get('/tipomuestra/:id',ctrl.tipomuestra.obtenerTipoMuestra);
router.post('/tipomuestra',ctrl.tipomuestra.nuevoTipoMuestra);
router.put('/tipomuestra',ctrl.tipomuestra.actualizarTipoMuestra);
