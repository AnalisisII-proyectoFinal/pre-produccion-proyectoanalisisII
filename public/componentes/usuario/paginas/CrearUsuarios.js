...
export function CrearUsuarios(){
    const $crearusuarios = document.createElement('div');
        ...
        <section class="contenedor-usuario">
            ...
            <form action="" class="f-datos-usuario">
              ...
              <div><label for="" class="input-label">DPI:</label>
                <input type="text" class="input-dato"  id="u-dpi" placeholder="dpi" required=""/></div>
              ...
              <div><label for="" class="input-label">Tel/Celular:</label>
                <input type="text" class="input-dato"  id="u-t" placeholder="telefono" required=""/></div>
              <div><label for="" class="input-label">Correo Electrónico:</label>
                <input type="text" class="input-dato" id="u-c" placeholder="correo@gmail.com" required=""/></div>
            ...
            <div class="botones-institucion">
                <p><button id="btn-n-us" class="tercer-btn">Nuevo Usuario</button></p>
        ...
        function iniCrearUsuarios(){
          ...
          const btnNuevo=document.getElementById('btn-n-us');
          btnNuevo.addEventListener('click',(e)=>{
            const nuevoUsuario = new UiUsuario();
            nuevoUsuario.limpiarFormulario();
          })
